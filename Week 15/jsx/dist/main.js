...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animation */ \"./animation.js\");\n/* harmony import */ var _ease__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ease */ \"./ease.js\");\n\n\nconsole.log('animation demo');\nvar tl = new _animation__WEBPACK_IMPORTED_MODULE_0__[\"TimeLine\"]();\ntl.start();\ntl.add(new _animation__WEBPACK_IMPORTED_MODULE_0__[\"Animation\"](document.querySelector('#el1').style, \"transform\", 0, 500, 1000, 1000, _ease__WEBPACK_IMPORTED_MODULE_1__[\"ease\"], function (v) {\n  return \"translateX(\".concat(v, \"px)\");\n}));\ntl.add(new _animation__WEBPACK_IMPORTED_MODULE_0__[\"Animation\"](document.querySelector('#el2').style, \"transform\", 0, 500, 1000, 1000, _ease__WEBPACK_IMPORTED_MODULE_1__[\"easeIn\"], function (v) {\n  return \"translateX(\".concat(v, \"px)\");\n}));\ntl.add(new _animation__WEBPACK_IMPORTED_MODULE_0__[\"Animation\"](document.querySelector('#el3').style, \"transform\", 0, 500, 1000, 1000, _ease__WEBPACK_IMPORTED_MODULE_1__[\"easeOut\"], function (v) {\n  return \"translateX(\".concat(v, \"px)\");\n}));\ntl.add(new _animation__WEBPACK_IMPORTED_MODULE_0__[\"Animation\"](document.querySelector('#el4').style, \"transform\", 0, 500, 1000, 1000, _ease__WEBPACK_IMPORTED_MODULE_1__[\"easeInOut\"], function (v) {\n  return \"translateX(\".concat(v, \"px)\");\n})); // window.tl = tl;\n// window.animation = new Animation({ set a(v) {console.log(3, v);}}, \"a\", 0, 100, 1000, null);\n\ndocument.querySelector('#pause-btn').addEventListener('click', function () {\n  tl.pause();\n});\ndocument.querySelector('#resume-btn').addEventListener('click', function () {\n  tl.resume();\n});\n\n//# sourceURL=webpack:///./animation-demo.js?");
